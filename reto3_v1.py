...
def traducir_a_espanol(mensaje_a_traducir):
    ...
    mensaje = mensaje_a_traducir.split()  ##Separamos cada letra de frase ingresada ....y las guardamos en una lista, donde cada letra es un elemento de la lista ej: entrada: mensaje = "casa", mensaje.split(); salida: ["c","a","s","a"]
